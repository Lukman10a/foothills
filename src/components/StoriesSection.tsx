    ...
    <section className="py-16 lg:py-24 px-6 lg:px-16 bg-[#fdfaf2]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg lg:text-xl text-[#0d4747] opacity-90 leading-relaxed max-w-3xl">
          ...
          {stories.map((story) => (
            <article key={story.id} className="group cursor-pointer">
              ...
              <div className="space-y-4">
                <h3 className="text-xl lg:text-2xl font-light text-[#0d4747] leading-snug group-hover:text-[#1a5f5f] transition-colors duration-200">
                  {story.title}
                </h3>
                
                <p className="text-base text-[#0d4747] opacity-80 leading-relaxed">
                  {story.excerpt}
                </p>

                <div className="pt-2">
                  <button className="text-[#0d4747] font-medium underline hover:text-[#1a5f5f] transition-colors duration-200">
                    Continue reading
                  </button>
                </div>
              </div>
